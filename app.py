...
# O status controla as listas, mas NÃO altera os indicadores.
# =========================================================
...
if status_selecionado == "Realizadas":
    ...
    titulo_pendencias = "Colaboradores realizadas"
    mostrar_nota_pendencias = True
elif status_selecionado == "Pendentes":
    pendencias = df_filtrado[~df_filtrado["Realizada"]].copy()
    titulo_pendencias = "Colaboradores pendentes"
    mostrar_nota_pendencias = False
else:
    pendencias = df_filtrado[~df_filtrado["Realizada"]].copy()
    titulo_pendencias = "Colaboradores pendentes"
    mostrar_nota_pendencias = False
...
if pendencias.empty:
    ...
    st.html(
        html_lista(
            f"{titulo_pendencias} · {len(pendencias)}",
            pendencias,
            mostrar_nota=mostrar_nota_pendencias
        )
    )
