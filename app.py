...
# Mantém o universo completo para os indicadores e gráficos de acompanhamento.
# O status selecionado é aplicado aos detalhamentos/listas abaixo.
df_ativo = df_filtrado.copy()
df_status = df_lista.copy()
